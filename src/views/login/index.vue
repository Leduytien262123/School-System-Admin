<template>
  ...
  >
    ...
    >
      ...
      <div class="w-350 flex-col px-20 py-32">
        ...
        <!-- <div class="mt-20 flex items-center">
          ...
          >
            <template #prefix>
              <i class="i-fe:key mr-12 opacity-20"></i>
            </template>
          </n-input>
          <img
            v-if="captchaUrl"
        ...
        <div class="mt-20 flex items-center">
          <n-button
            class="mr-32 h-40 flex-1 rounded-5 text-16"
            type="primary"
            ghost
            @click="quickLogin()"
          >
...
function quickLogin() {
  ...
  loginInfo.value.password = "SupperAmin@123";
  handleLogin(true);
}
